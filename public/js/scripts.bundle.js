...
var KTDrawer = function (e, t) {
    ...
    if (null != e) {
        var r = {overlay: !0, direction: "end", baseClass: "drawer", overlayClass: "drawer-overlay"}, o = function () {
            ...
            var e = p(), t = f("direction"), r = f("top"), o = f("bottom"), a = f("start"), l = f("end");
    ...
    if (null != e) {
        var i = {dropdown: {hoverTimeout: 200, zindex: 105}, accordion: {slideSpeed: 250, expand: !1}},
            r = function () {
                ...
                e || (e = n.triggerElement), !0 !== m(e) && ("dropdown" === v(e) ? b(e) : "accordion" === v(e) && S(e), KTUtil.data(e).set("type", v(e)))
            }, l = function (e) {
                e || (e = n.triggerElement), !1 !== m(e) && ("dropdown" === v(e) ? E(e) : "accordion" === v(e) && A(e))
            }, s = function (e) {
                if (!1 !== f(e)) {
                    var t = g(e);
                ...
                if (!1 !== KTEventHandler.trigger(n.element, "kt.menu.dropdown.show", e)) {
                    ...
                    c(e) || p(e);
                    var t = g(e), i = I(e, "width"), r = I(e, "height"), o = n.options.dropdown.zindex,
                        a = KTUtil.getHighestZindex(e);
                    null !== a && a >= o && (o = a + 1), o > 0 && KTUtil.css(t, "z-index", o), null !== i && KTUtil.css(t, "width", i), null !== r && KTUtil.css(t, "height", r), KTUtil.css(t, "display", ""), KTUtil.css(t, "overflow", ""), w(e, t), KTUtil.addClass(e, "show"), KTUtil.addClass(e, "menu-dropdown"), KTUtil.addClass(t, "show"), !0 === I(e, "overflow") ? (document.body.appendChild(t), KTUtil.data(e).set("sub", t), KTUtil.data(t).set("item", e), KTUtil.data(t).set("menu", n)) : KTUtil.data(t).set("item", e), KTEventHandler.trigger(n.element, "kt.menu.dropdown.shown", e)
                }
            }, E = function (e) {
                if (!1 !== KTEventHandler.trigger(n.element, "kt.menu.dropdown.hide", e)) {
                    var t = g(e);
                    KTUtil.css(t, "z-index", ""), KTUtil.css(t, "width", ""), KTUtil.css(t, "height", ""), KTUtil.removeClass(e, "show"), KTUtil.removeClass(e, "menu-dropdown"), KTUtil.removeClass(t, "show"), !0 === I(e, "overflow") && (e.classList.contains("menu-item") ? e.appendChild(t) : KTUtil.insertAfter(n.element, e), KTUtil.data(e).remove("sub"), KTUtil.data(t).remove("item"), KTUtil.data(t).remove("menu")), k(e), KTEventHandler.trigger(n.element, "kt.menu.dropdown.hidden", e)
                }
            }, w = function (e, t) {
                var n, i = I(e, "attach");
                ...
                if (!1 !== KTEventHandler.trigger(n.element, "kt.menu.accordion.show", e)) {
                    ...
                    !0 === I(e, "expand") ? i = !0 : !1 === I(e, "expand") ? i = !1 : !0 === I(n.element, "expand") && (i = !0), !1 === i && x(e), !0 === KTUtil.data(e).has("popper") && E(e), KTUtil.addClass(e, "hover"), KTUtil.addClass(e, "showing"), KTUtil.slideDown(t, n.options.accordion.slideSpeed, (function () {
        ...
        !0 === KTUtil.data(e).has("menu") ? n = KTUtil.data(e).get("menu") : r(), n.click = function (e, t) {
            return function (e, t) {
                t.preventDefault();
                var n = T(e);
                "click" === I(n, "trigger") && (!1 === I(n, "toggle") ? a(n) : o(n))
            }(e, t)
        }, n.link = function (e, t) {
            return function (e, t) {
                !1 !== KTEventHandler.trigger(n.element, "kt.menu.link.click", e) && (KTMenu.hideDropdowns(), KTEventHandler.trigger(n.element, "kt.menu.link.clicked", e))
            }(e)
            ...
            return function (e, t) {
                var n = T(e);
                null !== n && "hover" === I(n, "trigger") && ("1" === KTUtil.data(n).get("hover") && (clearTimeout(KTUtil.data(n).get("timeout")), KTUtil.data(n).remove("hover"), KTUtil.data(n).remove("timeout")), a(n))
            }(e)
...
var KTScroll = function (e, t) {
    ...
    if (e) {
        var i = {saveState: !0}, r = function () {
            ...
            var e, t;
            !0 === m("activate") || !1 === n.element.hasAttribute("data-kt-scroll-activate") ? (e = f(), null !== (t = s()) && t.length > 0 ? KTUtil.css(n.element, e, t) : KTUtil.css(n.element, e, ""), l(), !0 === m("save-state") && void 0 !== KTCookie && n.id ? n.element.addEventListener("scroll", o) : n.element.removeEventListener("scroll", o), function () {
                if (!0 === m("save-state") && void 0 !== KTCookie && n.id && KTCookie.get(n.id + "st")) {
                    var e = parseInt(KTCookie.get(n.id + "st"));
                    e > 0 && (n.element.scrollTop = e)
                }
            }()) : (KTUtil.css(n.element, f(), ""), n.element.removeEventListener("scroll", o))
        }, l = function () {
            var e = m("stretch");
            if (null !== e) {
                var t = document.querySelectorAll(e);
                if (t && 2 == t.length) {
                    var i = t[0], r = t[1], o = d(r) - d(i);
                    if (o > 0) {
            ...
            var e = m(f());
            return e instanceof Function ? e.call() : null !== e && "string" == typeof e && "auto" === e.toLowerCase() ? u() : e
        }, u = function () {
            var e, t = KTUtil.getViewPort().height, i = m("dependencies"), r = m("wrappers"), o = m("offset");
            if ((t -= c(n.element), null !== i) && ((e = document.querySelectorAll(i)) && e.length > 0)) for (var a = 0, l = e.length; a < l; a++) !1 !== KTUtil.visible(e[a]) && (t -= d(e[a]));
            if (null !== r && ((e = document.querySelectorAll(r)) && e.length > 0)) for (a = 0, l = e.length; a < l; a++) !1 !== KTUtil.visible(e[a]) && (t -= c(e[a]));
            ...
            return m("height") ? "height" : m("min-height") ? "min-height" : m("max-height") ? "max-height" : void 0
        };
...
var KTSticky = function (e, t) {
    ...
    if (null != e) {
        var r = {
            ...
            n.element = e, n.options = KTUtil.deepExtend({}, r, t), n.uid = KTUtil.getUniqueId("sticky"), n.name = n.element.getAttribute("data-kt-sticky-name"), n.attributeName = "data-kt-sticky-" + n.name, n.attributeName2 = "data-kt-" + n.name, n.eventTriggerState = !0, n.lastScrollTop = 0, n.scrollHandler, n.element.setAttribute("data-kt-sticky", "true"), window.addEventListener("scroll", a), a(), KTUtil.data(n.element).set("sticky", n)
        }, a = function (e) {
            var t, r, o = d("offset"), a = d("release-offset"), u = d("reverse");
            !1 !== o && (o = parseInt(o), a = a ? parseInt(a) : 0, t = KTUtil.getScrollTop(), r = document.documentElement.scrollHeight - window.innerHeight - KTUtil.getScrollTop(), !0 === u ? (t > o && (0 === a || a < r) ? (!1 === i.hasAttribute(n.attributeName) && (l(), i.setAttribute(n.attributeName, "on"), i.setAttribute(n.attributeName2, "on")), !0 === n.eventTriggerState && (KTEventHandler.trigger(n.element, "kt.sticky.on", n), KTEventHandler.trigger(n.element, "kt.sticky.change", n), n.eventTriggerState = !1)) : (!0 === i.hasAttribute(n.attributeName) && (s(), i.removeAttribute(n.attributeName), i.removeAttribute(n.attributeName2)), !1 === n.eventTriggerState && (KTEventHandler.trigger(n.element, "kt.sticky.off", n), KTEventHandler.trigger(n.element, "kt.sticky.change", n), n.eventTriggerState = !0)), n.lastScrollTop = t) : t > o && (0 === a || a < r) ? (!1 === i.hasAttribute(n.attributeName) && (l(), i.setAttribute(n.attributeName, "on"), i.setAttribute(n.attributeName2, "on")), !0 === n.eventTriggerState && (KTEventHandler.trigger(n.element, "kt.sticky.on", n), KTEventHandler.trigger(n.element, "kt.sticky.change", n), n.eventTriggerState = !1)) : (!0 === i.hasAttribute(n.attributeName) && (s(), i.removeAttribute(n.attributeName), i.removeAttribute(n.attributeName2)), !1 === n.eventTriggerState && (KTEventHandler.trigger(n.element, "kt.sticky.off", n), KTEventHandler.trigger(n.element, "kt.sticky.change", n), n.eventTriggerState = !0)), a > 0 && (r < a ? n.element.setAttribute("data-kt-sticky-released", "true") : n.element.removeAttribute("data-kt-sticky-released")))
        }, l = function (e) {
            var t = d("top"), i = d("left"), r = d("right"), o = d("width"), a = d("zindex"), l = d("dependencies"),
                s = d("class"), c = u();
            if (!0 !== e && !0 === d("animation") && (KTUtil.css(n.element, "animationDuration", d("animationSpeed")), KTUtil.animateClass(n.element, "animation " + d("animationClass"))), null !== s && KTUtil.addClass(n.element, s), null !== a && (KTUtil.css(n.element, "z-index", a), KTUtil.css(n.element, "position", "fixed")), null !== t && KTUtil.css(n.element, "top", t), null !== o) {
                if (o.target) {
            ...
            if (null !== r && KTUtil.css(n.element, "right", r), null !== l) {
                ...
                if (p && p.length > 0) for (var g = 0, v = p.length; g < v; g++) KTUtil.css(p[g], "padding-top", String(c) + "px")
            }
        }, s = function () {
            ...
            var e = d("dependencies"), t = d("class");
        ...
        !0 === KTUtil.data(e).has("sticky") ? n = KTUtil.data(e).get("sticky") : o(), n.update = function () {
            !0 === i.hasAttribute(n.attributeName) && (s(), i.removeAttribute(n.attributeName), i.removeAttribute(n.attributeName2), l(!0), i.setAttribute(n.attributeName, "on"), i.setAttribute(n.attributeName2, "on"))
        }, n.destroy = function () {
...
var KTApp = function () {
    ...
    return {
        init: function () {
            this.initBootstrapTooltips(), this.initBootstrapPopovers(), this.initBootstrapScrollSpy(), this.initDaterangepicker(), this.initButtons(), this.initCheck(), this.initSelect2(), this.initCountUp(), this.initCountUpTabs(), this.initAutosize(), this.initTinySliders(), this.initSmoothScroll(), this.initBootstrapToast(), this.initBootstrapCollapse(), this.initBootstrapRotate()
            ...
            !function (e, t) {
                var n = function (e, t) {
                    return new Promise((function (n, i) {
                        var r = document.querySelector("link[href*='" + e + "']"), o = document.createElement("link"),
                            a = r.href.replace(e, t);
                        o.rel = "stylesheet", o.type = "text/css", o.href = a, document.head.insertBefore(o, r), o.onload = function () {
                            n(a), r.remove()
                        }, o.onerror = function () {
                            i(a)
                        }
                ...
                document.body.classList.add("page-loading"), "dark" === e ? Promise.all([n("plugins.bundle.css", "plugins.dark.bundle.css"), n("style.bundle.css", "style.dark.bundle.css")]).then((function () {
                    document.body.classList.add("dark-mode"), document.body.classList.remove("page-loading"), t instanceof Function && t()
                })).catch((function () {
                })) : "light" === e && Promise.all([n("plugins.dark.bundle.css", "plugins.bundle.css"), n("style.dark.bundle.css", "style.bundle.css")]).then((function () {
                    document.body.classList.remove("dark-mode"), document.body.classList.remove("page-loading"), t instanceof Function && t()
                })).catch((function () {
                }))
            }(e, t)
        }
