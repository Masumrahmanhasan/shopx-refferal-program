    ...
    <div class="py-4">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="flex items-start mt-4">
                <div class="relative bg-white border-1 z-1 sm:rounded-lg max-w-xs flex-320 shadow-sm">
                    <div class="overflow-auto px-6 pb-6">
                        <div class="avatar p-6 text-center mb-6 relative border-b border-gray-300">
                            <span class="relative w-16 h-16 mb-4 rounded-full inline-flex items-center font-semibold justify-center">
                                <img src="https://demo.activeitzone.com/ecommerce/public/assets/img/avatar-place.png" class="w-full h-full rounded-full object-cover" alt="">
                                <span class="-bottom-1 left-9 absolute  w-3.5 h-3.5 bg-green-400 border-2 border-white dark:border-gray-800 rounded-full"></span>
                            </span>
                        ...
                        <div class="sidemnenu">
                            <ul class="aiz-side-nav-list mb-3 pb-3 border-bottom metismenu" data-toggle="aiz-side-menu">
                                ...
                                <li class="aiz-side-nav-item mm-active">
                                    <a href="https://demo.activeitzone.com/ecommerce/dashboard" class="aiz-side-nav-link active" aria-expanded="true">
