            ...
            <div x-data="{ tab: 0 }" x-cloak class=" mt-5 antialiased">
                <div class="relative flex flex-col rounded-lg shadow-xs">
                    ...
                    <div class="sm:block md:flex bg-white border-b border-gray-200 gap-5 justify-center">
                        ...
                        {{-- Rocket --}}
                        <button type="button"
                                class="hidden sm:w-full lg: w-1/4 focus:outline-none text-gray-400 hover:text-gray-500 py-2 px-1 border-t-2 text-sm tracking-wide font-medium border-transparent rounded-xl mb-6"
                    ...
                    <div class="">
                        ...
                        <div x-show="tab === 2">
                            ...
                            <div class="bg-[#FF5C00] mt-5 mb-5 p-7 rounded-xl text-center sm:px-4 py-5">
                                ...
                                <p class="mt-5 text-white">
                                    উপরের নগদ নাম্বারে উল্লেখিত ফি স{{ env('NAGAD_PAYMENT_TYPE') }} করার পর নিচের ২ টা
                                    খালি ঘর পূরন করুন। ১ম
                            ...
                            <div class="p-6  bg-white rounded-xl shadow-lg border border-solid border-[#2196f3]">
                                ...
                                <form action="" method="POST">
                                    <div class="w-3/4 m-auto sm:w-full">
                                        ...
                                        <div class="text-center">
                                            <button type="submit"
                                                    class="mt-5 m-auto bg-pink-700 py-2 px-5 rounded-md text-white">
                                                Verify
                                                Payment
                                            </button>
                                        </div>
