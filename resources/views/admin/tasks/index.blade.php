            ...
            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                ...
                @foreach($tasks as $task)
                    <tr>
                        ...
                        <!--begin::Email=-->
                        <td width="30%">
                            <a href="#" class="text-gray-600 text-hover-primary mb-1">{{ \Illuminate\Support\Str::substr($task->description, 0, 50) }}...</a>
                        </td>
                        <!--end::Email=-->
                        <!--begin::Status=-->
                        <td>
                            @if($task->status === 'active')
                                <div class="badge badge-light-success">{{ ucfirst($task->status) }}</div>
                            @else
                                <div class="badge badge-light-danger">{{ ucfirst($task->status) }}</div>
                            @endif
                            <!--begin::Badges-->
                            <!--end::Badges-->
                        </td>
