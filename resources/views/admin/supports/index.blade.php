...
{{--                                                    <img src="{{ $support->thumbnail }}" alt="{{ $support->title }}"--}}
{{--                                                         class="w-100"/>--}}
{{--                                                @else--}}
{{--                                                    <div--}}
{{--                                                        class="symbol-label fs-3 bg-light-primary text-danger">{{ substr($support->title, 0, 1) }}</div>--}}
{{--                                                @endif--}}
{{--                                            </div>--}}
{{--                                        </a>--}}
{{--                                    </div>--}}
                                    ...
                                    <div class="d-flex flex-column">
                                        <a href="#"
                                           class="text-gray-800 text-hover-primary mb-1">{{ $support->title }}</a>
                                        <span>{{ $support->created_at }}</span>
                                    </div>
                                    <!--begin::User details-->
                                </td>
                                <!--end::User=-->
                                ...
                                <!--begin::Two step=-->
                                <td>
                                    <div class="badge badge-light-success fw-bolder">{{ ucfirst($support->status) }}</div>
                                </td>
                                ...
                                <td class="text-end">
                                    ...
                                    <div
                                        ...
                                        <input type="hidden" data-kt-task-list-filter="task_id" value="{{ $support->id }}">
                                        <div class="menu-item px-3">
...
@section('scripts')
    <script src="{{ asset('js/custom/apps/support-management/support/list/table.js') }}"></script>
@endsection
