            ...
            <div class="card-body">
                <div class="text-center mb-4">
                    <a href="#" class="navbar-brand navbar-brand-autodark">
                        ...
                        <span class="text-2xl">Profit Work-BD</span>
                    </a>
                </div>
                ...
                <form action="{{ route('admin.login') }}" method="POST">
                    ...
                    <div class="mb-2">
                        ...
                        <div class="input-group input-group-flat" x-data="{showPassword : false}">
                            <input x-bind:type="showPassword ? 'text' : 'password'" class="form-control" name="password" placeholder="Your password" autocomplete="off">
                            <span class="input-group-text">

                                <a href="#" @click="showPassword = !showPassword" class="link-secondary" data-bs-toggle="tooltip" aria-label="Show password"
