    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <!--begin::Title-->
                <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Users Create</h1>
                <!--end::Title-->
                <!--begin::Separator-->
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-dark">Users Create</li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
                            ...
                            <div class="card card-flush py-4">
                                ...
                                <div class="card-body pt-0">
                                    ...
                                    <div class="mb-5 fv-row" id="kt_ecommerce_check_type">
                                        ...
                                        <select class="form-select" name="referred_by" data-kt-select2="true" data-placeholder="Select Referral" data-allow-clear="true">
                                            ...
                                            @foreach($users as $user)
                                                <option value="{{ $user->referral_id }}">{{ $user->username }}</option>
                                            @endforeach
                                    ...
                                    <div class="mb-5 fv-row">
                                        ...
                                        <!--end::Input-->
                                        <!--begin::Description-->
                                        <div class="text-muted fs-7">A Password is required</div>
                                        <!--end::Description-->
                                    </div>
