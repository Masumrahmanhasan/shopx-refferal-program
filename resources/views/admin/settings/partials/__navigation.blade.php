    ...
    <div class="card-body pt-9 pb-0">
        ...
        <div class="d-flex flex-wrap flex-sm-nowrap mb-3">
            ...
            <div class="me-7 mb-4">
                <div class="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative">
                    <img src="{{ auth()->user()->thumbnail ?? asset('media/avatars/blank.png') }}" alt="image"/>
                    <div
        ...
        <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder">
            ...
            <li class="nav-item mt-2">
                <a class="nav-link text-active-primary ms-0 me-10 py-5 @if(Route::currentRouteName() === 'admin.settings.profile') active @endif"
                   href="{{ route('admin.settings.profile') }}">Settings</a>
            </li>
            ...
            <li class="nav-item mt-2">
                <a class="nav-link text-active-primary ms-0 me-10 py-5 @if(Route::currentRouteName() === 'admin.websiteSettings') active @endif" href="{{ route('admin.websiteSettings') }}">Website Settings</a>
            </li>
