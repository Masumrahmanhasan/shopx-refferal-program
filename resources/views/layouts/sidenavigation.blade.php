    ...
    <div class="overflow-auto px-6 pb-6">
        ...
        <div class="sidemnenu">
            <ul class="list-none mb-4 pb-4">
                ...
                <!-- Dashboard -->
                <li class="hover:bg-purple_light-50 rounded-3xl hover:text-white user-menu @if(Route::currentRouteName() === 'dashboard') bg-purple_light-50 text-white active @endif">
                    <a href="{{ route('dashboard') }}"
                       class="flex items-center mb-2 font-bolder px-3 py-2 active"
                       aria-expanded="true">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                             viewBox="0 0 16 16" class="hover:fill-dark">
                            <g id="Group_24768" data-name="Group 24768"
                               transform="translate(3495.144 -602)">
                ...
                <li class="hover:bg-purple_light-50 rounded-3xl hover:text-white user-menu @if(Route::currentRouteName() === 'profile.edit') bg-purple_light-50 text-white active @endif">
